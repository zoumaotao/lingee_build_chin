const employeeTickets = [
  ...
  { id: "HD-2026-0811-0215", title: "申请安装 Power BI Desktop", category: "IT / Software Request", status: "待审批", statusKey: "pending", viewGroup: "processing", priority: "Medium", updated: "1 小时前", owner: "审批队列", team: "IT Application", sla: "剩余 6小时20分", description: "软件安装申请已进入 L1 审批，审批结果以后台工单系统返回为准。", timeline: [["08:36", "申请已提交"], ["08:38", "规则检查完成"], ["08:40", "进入 L1 审批"]] },
  { id: "HD-2026-0810-0198", title: "Outlook 邮件同步异常", category: "IT / Email", status: "待确认", statusKey: "pending", viewGroup: "processing", priority: "Medium", updated: "昨天 16:42", owner: "Mei Ling", team: "IT Service Desk", sla: "剩余 18小时", description: "处理人已完成邮箱配置刷新，等待确认邮件是否恢复同步。", timeline: [["昨天 14:10", "工单已创建"], ["昨天 15:26", "处理人更新了邮箱配置"], ["昨天 16:42", "等待你的确认"]] },
  { id: "HD-2026-0809-0174", title: "重置 HR Portal 密码", category: "People GBS / HR Portal", status: "已解决待评价", statusKey: "rating", viewGroup: "rating", priority: "Low", updated: "8月9日", owner: "Sarah Lim", team: "People GBS", sla: "已完成", description: "密码重置已完成，等待员工评价后关闭。", timeline: [["8月9日 10:03", "工单已创建"], ["8月9日 10:18", "密码重置完成"], ["8月9日 10:22", "员工确认已解决，等待评价"]] },
  { id: "HD-2026-0807-0152", title: "办公区打印机驱动安装", category: "IT / Workplace", status: "已评价关闭", statusKey: "closed", viewGroup: "closed", priority: "Low", updated: "8月7日", owner: "Daniel Wong", team: "IT Workplace", sla: "已完成", description: "打印机驱动已安装并验证，员工已提交五星评价，工单正式关闭。", timeline: [["8月7日 09:12", "工单已创建"], ["8月7日 09:45", "驱动安装并验证"], ["8月7日 10:02", "员工评价后关闭"]] }
];

const agentTickets = [
  { id: "HD-2026-0811-0249", title: "财务共享盘访问权限异常", category: "IT / Access", status: "已超时", statusKey: "overdue", viewGroup: "pending", priority: "High", updated: "8 分钟前", owner: "你", team: "IT Service Desk", sla: "已超时 18分", description: "Finance 团队 4 名成员无法访问共享盘，需要核对权限组与最近一次组织调整。", timeline: [["08:20", "工单已自动分配"], ["08:32", "用户补充影响范围"], ["09:20", "响应 SLA 已超时"]] },
  ...
  { id: "HD-2026-0811-0227", title: "新员工无法登录协作平台", category: "IT / Identity", status: "新工单", statusKey: "new", viewGroup: "pending", priority: "Medium", updated: "21 分钟前", owner: "待接单", team: "IT Service Desk", sla: "剩余 3小时11分", description: "新员工首次登录提示账号不存在，需要检查身份同步状态。", timeline: [["09:06", "工单已创建"], ["09:07", "按分类分配至共享池"]] },
  { id: "HD-2026-0811-0215", title: "申请安装 Power BI Desktop", category: "IT / Software Request", status: "已处理待审批", statusKey: "pending", viewGroup: "processed", priority: "Medium", updated: "1 小时前", owner: "审批队列", team: "IT Application", sla: "剩余 6小时20分", description: "处理人已完成前置检查并转入 L1 审批，当前无需继续操作。", timeline: [["08:36", "申请已提交"], ["08:38", "处理人完成前置检查"], ["08:40", "进入 L1 审批"]] },
...
const roleConfigs = {
  employee: {
    ...
    stats: [["进行中", "3", "含审批与待确认", "warn"], ["待评价", "1", "服务已解决", "warn"], ["本月已关闭", "12", "+3 较上月", "good"], ["平均满意度", "4.8", "最近 6 次评价", "good"]]
  },
  agent: {
    workspaceTitle: "我的任务",
